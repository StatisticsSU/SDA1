...
I den här uppgiften ska vi modellera variabeln `logcost = log(df$cost)` som oberoende observationer från en $N(\mu,\sigma)$ fördelning. Skatta $\mu$ och $\sigma$ från data.
...
Jämför median av variabeln `logcost` med medianen från den skattade sannolikhetsmodellen från Uppgift 2.1.

#### 💪 Uppgift 2.4

Gör ett 95%-igt konfidensintervall för $\mu$ i modellen för `logcost` från Uppgift 2.1, både genom att använda formellsamlingen och genom att använda en funktion i R. Tolka intervallet.
