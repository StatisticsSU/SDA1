...
- Kursens egna R-paket `sda1` (se nedan) har också ett [cheat sheet](R/cheatsheets/sda1_cheatsheet.pdf).
...
[cheat sheet](R/cheatsheets/sda1_cheatsheet.pdf) | [manual](https://github.com/StatisticsSU/sda1paket/raw/main/sda1_0.0.1.pdf)

::: column-margin
[![](misc/hexagons/figs/sda1paketlogo.svg){fig-alt="sda1 kurspaket för R" fig-align="center" width="60"}](https://github.com/StatisticsSU/sda1paket)
:::
