...
::: column-margin
[![](../../slides/figs/flaticons/romeo-and-juliet.svg){width="60"}](https://doorshakespeare.com/general/whats-in-a-name/)
:::
...
Vi vill nu läsa in data från Excelfilen stock.xlsx. Du kan ladda ner den filen [här](https://statisticssu.github.io/SDA1/datorlab/lab1/stock.xlsx). Beroende på din dator så kommer en av två saker hända:
...
::: column-margin
<center>![](../../slides/figs/flaticons/Spotify_Icon_RGB_Green.png){width="40"}</center>
...
::: column-margin
[![](../../misc/hexagons/figs/mosaic_hexagon.svg){width="60"}](../../R/BaseRSyntax.qmd#scatter-plot) [![](../../misc/hexagons/figs/tidyverse_hexagon.svg){width="60"}](../../R/TidyverseSyntax.qmd#scatter-plot)
:::
