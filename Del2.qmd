...
Läs: SDM Kapitel 15.1, 15.2, 15.3, 15.6 | [Slides](/slides/F15DiskretaModeller.pdf)\
Interaktivt: [geometrisk fördelning](/observable/geometriskfordelning.qmd) | [binomialfördelningen](/observable/binomialfordelningen.qmd) | [Poissonfördelningen](/observable/poissonfordelningen.qmd) | [maximum likelihood - Poisson](/observable/ml_poisson.qmd)\
Kod:  [geometric.R](/code/geometric.R)

**Föreläsning 16 - Kontinuerliga sannolikhetsmodeller.**\
Läs: SDM Kapitel 5.3, 14.4, 15.7 | [Slides](/slides/F16KontinuerligaModeller.pdf) \
Interaktivt: [likformig](/observable/uniformfordelning.qmd) | [exponential](/observable/exponentialfordelningen.qmd) | [student-t](/observable/studentt.qmd) | [allmän student-t](/observable/studentt_allman.qmd)\
...
**Övning 13 - Konfidensintervall för ett väntevärde.**\
Uppgifter: SDM 17 

**Övning 14 - Hypotestest.**\
Uppgifter: SDM 18 

**Övning 15 - Jämföra grupper.**\
Uppgifter: SDM 20-21. 
