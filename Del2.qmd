...
**Föreläsning 15 - Sannolikhetsmodeller för diskreta slumpvariabler**\
Läs: SDM Kapitel 15.1, 15.2, 15.3, 15.6 \| [Slides](/slides/F15DiskretaSannolikhetsmodeller.pdf)\
...
**Föreläsning 16 - Sannolikhetsmodeller för kontinuerliga slumpvariabler**\
Läs: SDM Kapitel 5.3, 14.4, 15.7 \| [Slides](/slides/F16KontinuerligaSannolikhetsmodeller.pdf)\
...
Läs: SDM Kapitel 18 (ej *Random matters* på sid 579) \| [Slides](/misc/larry.png)\
Interaktivt: [hypotestest väntevärde](/observable/hypotesttest_mean.qmd)

**Föreläsning 20 - Inferens i multipel regression.**\
...
**Föreläsning 22 - Jämföra grupper och** $\chi^2$-test.\
Läs: SDM Kapitel 21.1, 21.2, 22.1 \| [Slides](/misc/larry.png)\
...
**Föreläsning 24 - Sammanfattning och räkning av övningstenta.**\
Läs: [Slides](/misc/larry.png)
...
Uppgifter: SDM 16.2, 16.3, 16.5, 16.7, 16.14, 16.16, 16.27a-c), 16.31.

**Övning 13 - Hypotestest.**\
Uppgifter: SDM 18, 19.

**Övning 14 - Jämföra grupper och chi2-test.**\
Uppgifter: SDM 20, 21, 22.

**Övning 15 - Inferens för regression.**\
Uppgifter: SDM 23
...
Uppgifter: [Datorlab 6](/datorlab/lab6/DatorLab6.qmd) | <a href="https://github.com/StatisticsSU/SDA1/raw/main/datorlab/lab6/DatorLab6.qmd" download>quarto</a>
